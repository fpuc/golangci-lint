...
There is a [`.golangci.example.yml`](https://github.com/fpuc/golangci-lint/blob/master/.golangci.example.yml) file with all supported options, their description, and default values.
